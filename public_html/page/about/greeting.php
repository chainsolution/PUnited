					...
					<article>
						<div class="paragraph">
							...
							<p>
								...
								社会を豊かに楽しくする」という企業理念の下、新たなる事業にも積極的にチャレンジし、地域活性化の一役を担うべく、
								全社一丸となって業務に邁進していく所存です。 
							</p>

							<p>
								21世紀に入り、ICTはさらに進化し、コミュニケーション事業を取り巻く環境は大きく変化して参りました。 
								「いつでも、どこでも、何でも、誰でも」ネットワークに接続し情報の受発信ができるユビキタス社会が到来したといっても過言ではないでしょう。
								さらにデバイスの進化や人工知能技術の進化等さらなる技術進化が生まれようとしています。そうした技術の進化の中に合っても、
								フランス語で「互いが顔を向け合い、見つめ合うこと」を意味します社名「ビザビ」の名のとおり、直接お会いした上での心の通うコミュニケーションを大切にし、
								地域の方々の価値創造に向けて「新しい、うれしい、面白い」情報や企画をお届けする「クリエイティブ・カンパニー」、
								地域に根差しながらもグローバルな視点を持つ「スーパーローカル」な存在として取り組みを進めてまいります。
							</p>

						</div>
						<div class="profile">
							<img src="public_html/img/about_us/greeting/about_us_en_ceo_profile_03.png">
						</div>
					</article>
				</div>
				<!-- /Greeting message -->
